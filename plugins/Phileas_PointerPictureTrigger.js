...
/*:
 * @target MZ
 * @plugindesc v1.8.1 Triggering of the switch/variable/common event when the pointer acts with the picture
...
/*:ru
 * @target MZ
 * @plugindesc v1.8.1 Срабатывание переключателя/переменной/общего события при действии указателя с картинкой
 * @author Phileas, ZX_Lost_Soul
 *
 * @command assign
 * @text Назначить
