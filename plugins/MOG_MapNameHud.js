...
/*:
 * @target MZ
 * @plugindesc (v1.1-Phileas) Apresenta uma Hud com o nome do mapa.
 * @author Moghunter (Phileas mod)
 ...
 * @help  
 * =============================================================================
 * +++ MOG Map Name Hud(v1.1-Phileas) +++
 * By Moghunter (Phileas mod)
 ...
 * * HISTÓRICO
 * =============================================================================
 * (v1.1-Phileas) Added font face option.  
...
/*:ru
 * @target MZ
 * @plugindesc (v1.1-Phileas) Отображает HUD с названием карты
 * @author Moghunter (Phileas mod)
 * @url https://mogplugins.wordpress.com
 *
 * @param Hud X-Axis
 * @text X-координата HUD
 * @default 250
 *
 * @param Hud Y-Axis
 * @text Y-координата HUD
 * @default 60
 *
 * @param Name X-Axis
 * @text X-координата надписи
 * @default 80
 *
 * @param Name Y-Axis
 * @text Y-координата надписи
 * @default 15
 *
 * @param Duration
 * @text Время отображения
 * @default 160
 * 
 * @param Font Face
 ...
 *
 * @param Font Italic
 * @text Курсивный шрифт
 * @default false
 *
 * @param Slide Animation
 * @text Анимация смахивания
 * @default true
 *
 * @param Zoom Animation
 * @text Анимация приближения
 * @default false
 *
 * @param Zoom Text Animation
 * @text Анимация приближения текста
 * @default true
 * 
 * @param Particle Animation
 * @text Анимация частиц
 * @default true
 *
 * @param Particles Number
 * @text Кол-во частиц
 ...
 *
 * @param Circle Animation
 * @text Круговая анимация
 * @default true
 *
 * @param Circle X-Axis
 * @text X-координата круговой анимации
 * @default -120
 *
 * @param Circle Y-Axis
 * @text Y-координата круговой анимации
 * @default 0
 *
 * @param Circle Z-Index
 * @text Z-индекс круговой анимации
 * @desc 0 - Ниже макета  /  1 - Выше макета.
 * @default 0
 *
 * @param Circle Rotation Speed
 * @text Скорость вращения круговой анимации.
 * @default 0.01
 *
 * @help  
 * =============================================================================
 ...
 * https://mogplugins.wordpress.com
 * =============================================================================
 * Отображает HUD с названием карты.
 * 
 * Файлы картинок располагать в директории
 * img/system/
 *
 * Список требуемых файлов (не требуются,
 * если отключены соответствующие анимации):
 * MapName.png
 * MapName_Circle.png
 * MapName_Particles.png 
 *
 ...
 * * ИСТОРИЯ ИЗМЕНЕНИЙ
 * =============================================================================
 * (v1.1-Phileas) Добавил опцию "Название шрифта" и локализовал плагин на русский.  
 * (v1.1) Correção na função sort relativo a codificação.  
 *
 */
...
　　var Moghunter = Moghunter || {}; 
  ...
  　Moghunter.parameters = PluginManager.parameters('MOG_MapNameHud');   
	...
	Moghunter.mhud_fontface = Moghunter.parameters['Font Face'] || 'GameFont';	
...
Map_Name_Hud.prototype.createName = function() {
	...
	this._name.bitmap.fontFace = Moghunter.mhud_fontface
